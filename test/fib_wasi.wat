...
;;=== User Code            BEGIN ===;;
  ...
  (func $main (export "_start") (result i32)
    ...
    (local.set $tmp___06 (call $wax::str_new (i32.const 8)))
    (local.set $crlf (local.get $tmp___06))
    
    
    (local.set $tmp___07 (call $wax::str_new (i32.const 11)))
    (local.set $tab (local.get $tmp___07))
    (if (i32.const 1) (then
      
      (local.set $i__s0e (i32.const 2))
      block $tmp__block_0000000002B3FBF0
      loop $tmp__lp_10
        (if (i32.const 1) (then
          ...
          (if (local.get $tmp___08__s0f) (then
                        ...
                        (br $tmp__block_0000000002B3FBF0)
          ))
