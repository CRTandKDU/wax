...
;;=== User Code            BEGIN ===;;
  (func $rot (export "rot") (param $n i32) (param $xy i32) (param $rx i32) (param $ry i32)
    (local $t__s61 i32)
    (local $tmp___03__s62 i32)
    (local $tmp___01__s61 i32)
    (local $tmp___02__s62 i32)
    (local $tmp___05__s62 i32)
    (local $tmp___04__s62 i32)
    (local $tmp___07__s62 i32)
    (local $tmp___06__s62 i32)
    (local $tmp___08__s61 i32)
    (local $tmp___09__s61 i32)
    (local $tmp___00 i32)
    
  
    (local.set $tmp___00 (i32.eq (local.get $ry) (i32.const 0)))
    (if (local.get $tmp___00) (then
      
      (local.set $tmp___01__s61 (i32.eq (local.get $rx) (i32.const 1)))
      (if (local.get $tmp___01__s61) (then
        
        
        (local.set $tmp___03__s62 (i32.sub (local.get $n) (i32.const 1)))
        
        (local.set $tmp___04__s62 (i32.load (i32.add (local.get $xy) (i32.mul (i32.const 0) (i32.const 4)))))
        (local.set $tmp___02__s62 (i32.sub (local.get $tmp___03__s62) (local.get $tmp___04__s62)))
        (i32.store (i32.add (local.get $xy) (i32.mul (i32.const 0) (i32.const 4)))(local.get $tmp___02__s62))
        
        
        (local.set $tmp___06__s62 (i32.sub (local.get $n) (i32.const 1)))
        
        (local.set $tmp___07__s62 (i32.load (i32.add (local.get $xy) (i32.mul (i32.const 1) (i32.const 4)))))
        (local.set $tmp___05__s62 (i32.sub (local.get $tmp___06__s62) (local.get $tmp___07__s62)))
        (i32.store (i32.add (local.get $xy) (i32.mul (i32.const 1) (i32.const 4)))(local.get $tmp___05__s62))
      ))
      
      
      (local.set $tmp___08__s61 (i32.load (i32.add (local.get $xy) (i32.mul (i32.const 0) (i32.const 4)))))
      (local.set $t__s61 (local.get $tmp___08__s61))
      
      (local.set $tmp___09__s61 (i32.load (i32.add (local.get $xy) (i32.mul (i32.const 1) (i32.const 4)))))
      (i32.store (i32.add (local.get $xy) (i32.mul (i32.const 0) (i32.const 4)))(local.get $tmp___09__s61))
      (i32.store (i32.add (local.get $xy) (i32.mul (i32.const 1) (i32.const 4)))(local.get $t__s61))
    ))
  )
  (func $d2xy (export "d2xy") (param $n i32) (param $d i32) (param $xy i32)
    (local $tmp___16__s64 i32)
    (local $tmp___17__s64 i32)
    (local $tmp___14__s64 i32)
    (local $tmp___15__s64 i32)
    (local $tmp___12__s64 i32)
    (local $s__s63 i32)
    (local $tmp___13__s64 i32)
    (local $tmp___10__s64 i32)
    (local $tmp___11__s64 i32)
    (local $rx i32)
    (local $ry i32)
    (local $tmp___0f__s64 i32)
    (local $tmp___0e__s64 i32)
    (local $tmp___0d__s64 i32)
    (local $tmp___0c__s64 i32)
    (local $tmp___0b__s64 i32)
    (local $tmp___0a__s64 i32)
    (local $t i32)
    
  
    
    
    (local.set $t (local.get $d))
    (i32.store (i32.add (local.get $xy) (i32.mul (i32.const 0) (i32.const 4)))(i32.const 0))
    (i32.store (i32.add (local.get $xy) (i32.mul (i32.const 1) (i32.const 4)))(i32.const 0))
    (if (i32.const 1) (then
      
      (local.set $s__s63 (i32.const 1))
      block $tmp__block_000000000219D440
      loop $tmp__lp_79
        (if (i32.const 1) (then
          ...
          (local.set $tmp___0b__s64 (i32.lt_s (local.get $s__s63) (local.get $n)))
          (local.set $tmp___0a__s64 (local.get $tmp___0b__s64))
          (if (local.get $tmp___0a__s64) (then
          
          )(else
            (call $wax::pop_stack)
            (br $tmp__block_000000000219D440)
          ))
          
          
          (local.set $tmp___0d__s64 (i32.div_s (local.get $t) (i32.const 2)))
          (local.set $tmp___0c__s64 (i32.and (i32.const 1) (local.get $tmp___0d__s64)))
          (local.set $rx (local.get $tmp___0c__s64))
          
          
          (local.set $tmp___0f__s64 (i32.xor (local.get $t) (local.get $rx)))
          (local.set $tmp___0e__s64 (i32.and (i32.const 1) (local.get $tmp___0f__s64)))
          (local.set $ry (local.get $tmp___0e__s64))
          (call $rot (local.get $s__s63) (local.get $xy) (local.get $rx) (local.get $ry))
          
          
          (local.set $tmp___11__s64 (i32.load (i32.add (local.get $xy) (i32.mul (i32.const 0) (i32.const 4)))))
          
          (local.set $tmp___12__s64 (i32.mul (local.get $s__s63) (local.get $rx)))
          (local.set $tmp___10__s64 (i32.add (local.get $tmp___11__s64) (local.get $tmp___12__s64)))
          (i32.store (i32.add (local.get $xy) (i32.mul (i32.const 0) (i32.const 4)))(local.get $tmp___10__s64))
          
          
          (local.set $tmp___14__s64 (i32.load (i32.add (local.get $xy) (i32.mul (i32.const 1) (i32.const 4)))))
          
          (local.set $tmp___15__s64 (i32.mul (local.get $s__s63) (local.get $ry)))
          (local.set $tmp___13__s64 (i32.add (local.get $tmp___14__s64) (local.get $tmp___15__s64)))
          (i32.store (i32.add (local.get $xy) (i32.mul (i32.const 1) (i32.const 4)))(local.get $tmp___13__s64))
          
          (local.set $tmp___16__s64 (i32.div_s (local.get $t) (i32.const 4)))
          (local.set $t (local.get $tmp___16__s64))
          
          (local.set $tmp___17__s64 (i32.add (local.get $s__s63) (local.get $s__s63)))
          (local.set $s__s63 (local.get $tmp___17__s64))
          (call $wax::pop_stack)
  ...
  (func $hilbert_curve (export "hilbert_curve") (param $n i32) (result i32)
    (local $tmp___19__s66 i32)
    (local $tmp___1d__s66 i32)
    (local $tmp___1e__s66 i32)
    (local $d__s65 i32)
    (local $tmp___1a__s66 i32)
    (local $tmp___1b__s66 i32)
    (local $tmp___1c__s66 i32)
    (local $xy__s66 i32)
    (local $pts i32)
    (local $tmp___18 i32)
    ...
    (local.set $tmp___18 (call $wax::arr_new (i32.const 0)))
    (local.set $pts (local.get $tmp___18))
    (if (i32.const 1) (then
      
      (local.set $d__s65 (i32.const 0))
      block $tmp__block_00000000021CAF70
      loop $tmp__lp_7a
        (if (i32.const 1) (then
          ...
          (local.set $tmp___1b__s66 (i32.mul (local.get $n) (local.get $n)))
          (local.set $tmp___1a__s66 (i32.lt_s (local.get $d__s65) (local.get $tmp___1b__s66)))
          (local.set $tmp___19__s66 (local.get $tmp___1a__s66))
          (if (local.get $tmp___19__s66) (then
          
          )(else
            (call $wax::pop_stack)
            (br $tmp__block_00000000021CAF70)
          ))
          
          
          (local.set $tmp___1c__s66 (call $wax::calloc (i32.mul (i32.const 4) (i32.const 8))))
          (local.set $xy__s66 (local.get $tmp___1c__s66))
          (call $d2xy (local.get $n) (local.get $d__s65) (local.get $xy__s66))
          
          (local.set $tmp___1d__s66 (call $wax::arr_length (local.get $pts)))
          (call $wax::arr_insert (local.get $pts) (local.get $tmp___1d__s66) (local.get $xy__s66))
          
          (local.set $tmp___1e__s66 (i32.add (local.get $d__s65) (i32.const 1)))
          (local.set $d__s65 (local.get $tmp___1e__s66))
          (call $wax::pop_stack)
  ...
  (func $draw_curve (export "draw_curve") (param $pts i32) (param $n i32) (result i32)
    (local $tmp___3b__s6b i32)
    (local $col__s6e i32)
    (local $tmp___3e__s6e i32)
    (local $tmp___55__s72 i32)
    (local $tmp___53__s74 i32)
    (local $tmp___2a__s6a i32)
    (local $tmp___3d__s6e i32)
    (local $tmp___52__s74 i32)
    (local $tmp___2b__s6a i32)
    (local $tmp___51__s74 i32)
    (local $tmp___2c__s6a i32)
    (local $tmp___3a__s6b i32)
    (local $tmp___3f__s6e i32)
    (local $tmp___4a__s6e i32)
    (local $tmp___50__s74 i32)
    (local $tmp___2d__s6a i32)
    (local $tmp___4b__s6a i32)
    (local $tmp___2e__s6a i32)
    (local $tmp___43__s70 i32)
    (local $tmp___2f__s6a i32)
    (local $tmp___3c__s6e i32)
    (local $col__s6b i32)
    (local $tmp___54__s74 i32)
    (local $tmp___23__s68 i32)
    (local $row__s6e i32)
    (local $tmp___22__s68 i32)
    (local $tmp___25__s68 i32)
    (local $tmp___24__s68 i32)
    (local $row__s6b i32)
    (local $tmp___26__s68 i32)
    (local $tmp___32__s6b i32)
    (local $tmp___4d__s72 i32)
    (local $tmp___30__s6a i32)
    (local $tmp___33__s6b i32)
    (local $tmp___4e__s72 i32)
    (local $tmp___40__s6e i32)
    (local $tmp___31__s6b i32)
    (local $tmp___37__s6d i32)
    (local $tmp___41__s6e i32)
    (local $tmp___42__s6f i32)
    (local $tmp___46__s6e i32)
    (local $tmp___4f__s74 i32)
    (local $i__s69 i32)
    (local $tmp___36__s6c i32)
    (local $tmp___47__s6e i32)
    (local $tmp___34__s6b i32)
    (local $tmp___44__s6e i32)
    (local $tmp___27__s6a i32)
    (local $tmp___35__s6b i32)
    (local $tmp___45__s6e i32)
    (local $tmp___28__s6a i32)
    (local $tmp___29__s6a i32)
    (local $canv i32)
    (local $tmp___38__s6b i32)
    (local $tmp___48__s6e i32)
    (local $i__s67 i32)
    (local $tmp___39__s6b i32)
    (local $tmp___49__s6e i32)
    (local $i__s71 i32)
    (local $j__s73 i32)
    (local $tmp___1f i32)
    (local $tmp___4c i32)
    ...
    (local.set $tmp___1f (call $wax::arr_new (i32.const 0)))
    (local.set $canv (local.get $tmp___1f))
    
    
    
    (local.set $tmp___21 (i32.mul (local.get $n) (i32.const 3)))
    (local.set $tmp___20 (i32.sub (local.get $tmp___21) (i32.const 2)))
    (local.set $m (local.get $tmp___20))
    (if (i32.const 1) (then
      
      (local.set $i__s67 (i32.const 0))
      block $tmp__block_00000000021D1B10
      loop $tmp__lp_7b
        (if (i32.const 1) (then
          ...
          (local.set $tmp___24__s68 (i32.mul (local.get $n) (local.get $m)))
          (local.set $tmp___23__s68 (i32.lt_s (local.get $i__s67) (local.get $tmp___24__s68)))
          (local.set $tmp___22__s68 (local.get $tmp___23__s68))
          (if (local.get $tmp___22__s68) (then
          
          )(else
            (call $wax::pop_stack)
            (br $tmp__block_00000000021D1B10)
          ))
          
          (local.set $tmp___25__s68 (call $wax::arr_length (local.get $canv)))
          (call $wax::arr_insert (local.get $canv) (local.get $tmp___25__s68) (i32.const 32))
          
          (local.set $tmp___26__s68 (i32.add (local.get $i__s67) (i32.const 1)))
          (local.set $i__s67 (local.get $tmp___26__s68))
          (call $wax::pop_stack)
    ...
    (if (i32.const 1) (then
      ...
      (local.set $i__s69 (i32.const 1))
      block $tmp__block_00000000021D0400
      loop $tmp__lp_7c
        (if (i32.const 1) (then
          ...
          (local.set $tmp___29__s6a (call $wax::arr_length (local.get $pts)))
          (local.set $tmp___28__s6a (i32.lt_s (local.get $i__s69) (local.get $tmp___29__s6a)))
          (local.set $tmp___27__s6a (local.get $tmp___28__s6a))
          (if (local.get $tmp___27__s6a) (then
          
          )(else
            (call $wax::pop_stack)
            (br $tmp__block_00000000021D0400)
          ))
          
          
          
          (local.set $tmp___2b__s6a (i32.sub (local.get $i__s69) (i32.const 1)))
          (local.set $tmp___2a__s6a (call $wax::arr_get (local.get $pts) (local.get $tmp___2b__s6a)))
          (local.set $p0__s6a (local.get $tmp___2a__s6a))
          
          
          (local.set $tmp___2c__s6a (call $wax::arr_get (local.get $pts) (local.get $i__s69)))
          (local.set $p1__s6a (local.get $tmp___2c__s6a))
          
          
          
          (local.set $tmp___2e__s6a (i32.load (i32.add (local.get $p1__s6a) (i32.mul (i32.const 0) (i32.const 4)))))
          
          (local.set $tmp___2f__s6a (i32.load (i32.add (local.get $p0__s6a) (i32.mul (i32.const 0) (i32.const 4)))))
          (local.set $tmp___2d__s6a (i32.sub (local.get $tmp___2e__s6a) (local.get $tmp___2f__s6a)))
          (local.set $dx__s6a (local.get $tmp___2d__s6a))
          
          (local.set $tmp___30__s6a (i32.eq (local.get $dx__s6a) (i32.const 0)))
          (if (local.get $tmp___30__s6a) (then
            
            
            
            
            (local.set $tmp___33__s6b (i32.load (i32.add (local.get $p1__s6a) (i32.mul (i32.const 1) (i32.const 4)))))
            
            (local.set $tmp___34__s6b (i32.load (i32.add (local.get $p0__s6a) (i32.mul (i32.const 1) (i32.const 4)))))
            (local.set $tmp___32__s6b (i32.gt_s (local.get $tmp___33__s6b) (local.get $tmp___34__s6b)))
            
            (if (local.get $tmp___32__s6b) (then
              
              (local.set $tmp___36__s6c (i32.load (i32.add (local.get $p1__s6a) (i32.mul (i32.const 1) (i32.const 4)))))
              (local.set $tmp___35__s6b (local.get $tmp___36__s6c))
            )(else
              
              (local.set $tmp___37__s6d (i32.load (i32.add (local.get $p0__s6a) (i32.mul (i32.const 1) (i32.const 4)))))
              (local.set $tmp___35__s6b (local.get $tmp___37__s6d))
            ))
            (local.set $tmp___31__s6b (local.get $tmp___35__s6b))
            (local.set $row__s6b (local.get $tmp___31__s6b))
            
            
            
            (local.set $tmp___39__s6b (i32.load (i32.add (local.get $p1__s6a) (i32.mul (i32.const 0) (i32.const 4)))))
            (local.set $tmp___38__s6b (i32.mul (local.get $tmp___39__s6b) (i32.const 3)))
            (local.set $col__s6b (local.get $tmp___38__s6b))
            
            
            (local.set $tmp___3b__s6b (i32.mul (local.get $row__s6b) (local.get $m)))
            (local.set $tmp___3a__s6b (i32.add (local.get $tmp___3b__s6b) (local.get $col__s6b)))
            (call $wax::arr_set (local.get $canv) (local.get $tmp___3a__s6b) (i32.const 124))
          )(else
            
            
            (local.set $tmp___3c__s6e (i32.load (i32.add (local.get $p1__s6a) (i32.mul (i32.const 1) (i32.const 4)))))
            (local.set $row__s6e (local.get $tmp___3c__s6e))
            
            
            
            
            (local.set $tmp___3f__s6e (i32.load (i32.add (local.get $p1__s6a) (i32.mul (i32.const 0) (i32.const 4)))))
            
            (local.set $tmp___40__s6e (i32.load (i32.add (local.get $p0__s6a) (i32.mul (i32.const 0) (i32.const 4)))))
            (local.set $tmp___3e__s6e (i32.lt_s (local.get $tmp___3f__s6e) (local.get $tmp___40__s6e)))
            
            (if (local.get $tmp___3e__s6e) (then
              
              (local.set $tmp___42__s6f (i32.load (i32.add (local.get $p1__s6a) (i32.mul (i32.const 0) (i32.const 4)))))
              (local.set $tmp___41__s6e (local.get $tmp___42__s6f))
            )(else
              
              (local.set $tmp___43__s70 (i32.load (i32.add (local.get $p0__s6a) (i32.mul (i32.const 0) (i32.const 4)))))
              (local.set $tmp___41__s6e (local.get $tmp___43__s70))
            ))
            (local.set $tmp___3d__s6e (local.get $tmp___41__s6e))
            (local.set $col__s6e (local.get $tmp___3d__s6e))
            
            
            (local.set $tmp___45__s6e (i32.mul (local.get $col__s6e) (i32.const 3)))
            (local.set $tmp___44__s6e (i32.add (local.get $tmp___45__s6e) (i32.const 1)))
            (local.set $col__s6e (local.get $tmp___44__s6e))
            
            
            (local.set $tmp___47__s6e (i32.mul (local.get $row__s6e) (local.get $m)))
            (local.set $tmp___46__s6e (i32.add (local.get $tmp___47__s6e) (local.get $col__s6e)))
            (call $wax::arr_set (local.get $canv) (local.get $tmp___46__s6e) (i32.const 95))
            
            
            
            (local.set $tmp___4a__s6e (i32.mul (local.get $row__s6e) (local.get $m)))
            (local.set $tmp___49__s6e (i32.add (local.get $tmp___4a__s6e) (local.get $col__s6e)))
            (local.set $tmp___48__s6e (i32.add (local.get $tmp___49__s6e) (i32.const 1)))
            (call $wax::arr_set (local.get $canv) (local.get $tmp___48__s6e) (i32.const 95))
          ))
          
          (local.set $tmp___4b__s6a (i32.add (local.get $i__s69) (i32.const 1)))
          (local.set $i__s69 (local.get $tmp___4b__s6a))
          (call $wax::pop_stack)
    ...
    (local.set $tmp___4c (call $wax::str_new (i32.const 0)))
    (local.set $s (local.get $tmp___4c))
    (if (i32.const 1) (then
      
      (local.set $i__s71 (i32.const 0))
      block $tmp__block_00000000021E6FF0
      loop $tmp__lp_7d
        (if (i32.const 1) (then
          ...
          (local.set $tmp___4e__s72 (i32.lt_s (local.get $i__s71) (local.get $n)))
          (local.set $tmp___4d__s72 (local.get $tmp___4e__s72))
          (if (local.get $tmp___4d__s72) (then
          
          )(else
            (call $wax::pop_stack)
            (br $tmp__block_00000000021E6FF0)
          ))
          (if (i32.const 1) (then
            
            (local.set $j__s73 (i32.const 0))
            block $tmp__block_00000000021EC9A0
            loop $tmp__lp_7e
              (if (i32.const 1) (then
                ...
                (local.set $tmp___50__s74 (i32.lt_s (local.get $j__s73) (local.get $m)))
                (local.set $tmp___4f__s74 (local.get $tmp___50__s74))
                (if (local.get $tmp___4f__s74) (then
                
                )(else
                  (call $wax::pop_stack)
                  (br $tmp__block_00000000021EC9A0)
                ))
                
                
                
                (local.set $tmp___53__s74 (i32.mul (local.get $i__s71) (local.get $m)))
                (local.set $tmp___52__s74 (i32.add (local.get $tmp___53__s74) (local.get $j__s73)))
                (local.set $tmp___51__s74 (call $wax::arr_get (local.get $canv) (local.get $tmp___52__s74)))
                (local.set $s (call $wax::str_add (local.get $s) (local.get $tmp___51__s74)))
                
                (local.set $tmp___54__s74 (i32.add (local.get $j__s73) (i32.const 1)))
                (local.set $j__s73 (local.get $tmp___54__s74))
                (call $wax::pop_stack)
          ...
          (local.set $s (call $wax::str_add (local.get $s) (i32.const 10)))
          
          (local.set $tmp___55__s72 (i32.add (local.get $i__s71) (i32.const 1)))
          (local.set $i__s71 (local.get $tmp___55__s72))
          (call $wax::pop_stack)
    ...
    (call $wax::arr_free (local.get $canv))
        (local.get $s)
    return
  )
  (func $main (export "_start") (result i32)
    (local $s__s76 i32)
    (local $tmp___60__s76 i32)
    (local $pts__s76 i32)
    (local $tmp___57__s76 i32)
    (local $tmp___56__s76 i32)
    (local $tmp___59__s76 i32)
    (local $tmp___58__s76 i32)
    (local $tmp___5a__s76 i32)
    (local $tmp___5f__s78 i32)
    (local $i__s77 i32)
    (local $tmp___5e__s78 i32)
    (local $tmp___5d__s78 i32)
    (local $n__s76 i32)
    (local $tmp___5c__s78 i32)
    (local $tmp___5b__s78 i32)
    (local $order__s75 i32)
    
  (if (i32.const 1) (then
      
      (local.set $order__s75 (i32.const 1))
      block $tmp__block_00000000021F0C30
      loop $tmp__lp_7f
        (if (i32.const 1) (then
          ...
          (local.set $tmp___57__s76 (i32.le_s (local.get $order__s75) (i32.const 4)))
          (local.set $tmp___56__s76 (local.get $tmp___57__s76))
          (if (local.get $tmp___56__s76) (then
          
          )(else
            (call $wax::pop_stack)
            (br $tmp__block_00000000021F0C30)
          ))
          
          
          (local.set $tmp___58__s76 (i32.shl (i32.const 1) (local.get $order__s75)))
          (local.set $n__s76 (local.get $tmp___58__s76))
          
          
          (local.set $tmp___59__s76 (call $hilbert_curve (local.get $n__s76)))
          (local.set $pts__s76 (local.get $tmp___59__s76))
          
          
          (local.set $tmp___5a__s76 (call $draw_curve (local.get $pts__s76) (local.get $n__s76)))
          (local.set $s__s76 (local.get $tmp___5a__s76))
          (call $wax::print (local.get $s__s76))
          (if (i32.const 1) (then
            
            (local.set $i__s77 (i32.const 0))
            block $tmp__block_00000000021F4C40
            loop $tmp__lp_80
              (if (i32.const 1) (then
                ...
                (local.set $tmp___5d__s78 (call $wax::arr_length (local.get $pts__s76)))
                (local.set $tmp___5c__s78 (i32.lt_s (local.get $i__s77) (local.get $tmp___5d__s78)))
                (local.set $tmp___5b__s78 (local.get $tmp___5c__s78))
                (if (local.get $tmp___5b__s78) (then
                
                )(else
                  (call $wax::pop_stack)
                  (br $tmp__block_00000000021F4C40)
                ))
                
                (local.set $tmp___5e__s78 (call $wax::arr_get (local.get $pts__s76) (local.get $i__s77)))
                (call $wax::free (local.get $tmp___5e__s78))
                
                (local.set $tmp___5f__s78 (i32.add (local.get $i__s77) (i32.const 1)))
                (local.set $i__s77 (local.get $tmp___5f__s78))
                (call $wax::pop_stack)
          ...
          (call $wax::free (local.get $s__s76))
          (call $wax::arr_free (local.get $pts__s76))
          
          (local.set $tmp___60__s76 (i32.add (local.get $order__s75) (i32.const 1)))
          (local.set $order__s75 (local.get $tmp___60__s76))
          (call $wax::pop_stack)
...
(global $wax::min_addr (mut i32) (i32.const 4))
;;=== User Code            END   ===;;
